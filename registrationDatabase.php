...
//--------------------------------------------------------------------------------------------------------------------------------
	...
	$stmt = $conn->prepare("INSERT INTO registrationTable (firstName, lastName, eMail, userName, password, gender, activationCode) VALUES (?, ?, ?, ?, ?, ?, ?)");
	...
	$stmt->bind_param("sssssss", $fName, $lName, $eMail, $uName, $password, $gender, $verCode_hash); //Binding parameters into prepared statement
