<?php
	...
	$userName = mysqli_real_escape_string($conn, $userName); //Checking if the input text from the username field contains any SQL-injection type vulnerability

	//Prepared statement to prevent SQL-Injection::
	$query = "SELECT * FROM registrationTable WHERE userName = ?"; //Select query to check if the usename exists in the database
